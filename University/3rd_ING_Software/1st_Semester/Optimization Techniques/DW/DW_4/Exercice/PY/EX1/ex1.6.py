...
y_points = [2,3,7/3,2]  # y-coordinates of the polygon
...
ax.plot([0,74/18], [74/24, 0],color='red', linestyle='--')
...
ax.text(1.4, 2.5, r"$(1,\frac{7}{3}) Z \approx 24.6$", fontsize=12, ha='right', va='bottom')
