...
\item les cinq nombre de donne sont definie par : min \(Q_1\) \(Q_2\) \(Q_3\) max\\
    \[ \text{min} = 13\hspace{0.1cm}ans \hspace{0.15cm} , \hspace{0.15cm}Q_1 = 20\hspace{0.1cm}ans \hspace{0.15cm}, \hspace{0.15cm}Q_2 = 25\hspace{0.1cm}ans \hspace{0.15cm},\hspace{0.15cm} Q_3 =  35\hspace{0.1cm}ans \hspace{0.15cm},\hspace{0.15cm} \text{max} =  70\hspace{0.1cm}ans\]
\vspace{0.5cm}
...
\begin{prettyBox}{Limites}{red}
    \begin{itemize}
        ...
        \item On a \(\text{lim}_{sup} = 57.5\) ans, valeur normale et pas loin du max \(\Rightarrow\) on la prend comme limite.
    \end{itemize}
\end{prettyBox}
...
\item Le Q-plot permet de visualiser la distribution d'une seule variable, 
    tandis que le QQ-plot permet de comparer la distribution de deux variables différentes.
\end{enumerate}

\vspace{0.25cm}

\begin{prettyBox}{Biais}{red}
    On divise par $N-1$ car, si on utilise un échantillon petit et qu'on divise sur $N$, cela donne un résultat trop petit (biaisé). Pour résoudre ceci, on utilise la correction de Bessel en divisant par $N-1$.
\end{prettyBox}
\newpage
...
\begin{center}
Dans notre scatter plot on remarque plus la perssone est age plus a la de griasse donc c'est une corelation positive.
\end{center}
...
\begin{align*}
    r  & =\dfrac{\sum (x_i - \overline{x}) \cdot (y_i - \overline{y})}{(N-1) \cdot (\sigma_x \cdot \sigma_y)} \\[0.25cm]
     & =\dfrac{\sum (x_i - \overline{x}) \cdot (y_i - \overline{y})}{(18-1) \cdot (13.218 \cdot 9.254)} \\[0.25cm]
                    &= \frac{
                        \substack {\sqrt{549.433} \cdot ( \sqrt{5.198} + \sqrt{371.718}) + \sqrt{377.913} \cdot ( \sqrt{440.160}  + \sqrt{120.560})
                            + \sqrt{55.353} \cdot \sqrt{6.864} + \sqrt{29.593} \cdot \sqrt{8.294} + \\  
                            \sqrt{0.313} \cdot \sqrt{1.904}+ \sqrt{6.553} \cdot \sqrt{2.496}+ \sqrt{12.673} \cdot \sqrt{5.853} + \sqrt{30.913} \cdot \sqrt{33.872}
                            + \sqrt{57.153} \cdot (\sqrt{188.238} + \sqrt{10^{-4}}) + \\
                        \sqrt{111.513}\cdot\sqrt{2.016}  + \sqrt{183.873} \cdot (\sqrt{28.302} + \sqrt{16.974}) + \sqrt{183.873} \cdot \sqrt{154.246} + \sqrt{211.993} \cdot \sqrt{47.886}}
                    }{2079.429}\\[0.25cm]
                    &= \frac{1723.577}{2079.429}\\[0.25cm]
                     &= \boxed { 0.828}
    \end{align*}
    ...
    \begin{prettyBox}{Conclusion}{myblue}
On a \( r = 0.828 > 0 \Rightarrow \) corrélation positive, ce qui confirme l’interprétation du scatter plot.
    \end{prettyBox}
...
On a comme data set les notes suivantes d'un groupe de 10 étudiants pours les cours respectifs d'un module X et
un module Y :

\begin{figure}[H] 
  \centering 
  \includegraphics[width=0.55\textwidth]{table.png} 
\end{figure}

\vspace{0.25cm}

\begin{enumerate}
    \item Oui car l'intervalle des valeurs de TP, Test est de [0-10] alors que celui de la note final et EMD est de 
        [0-20] donc on doit normalise de tell sorte que tout attributs \(\in\) [0-20].

    \[
        \begin{cases}
            \text{TP\_NORMALISE}_i = \text{TP}_i \times 2 \\[0.25cm]
            \text{TEST\_NORMALISE}_i = TEST_i \times 2\\[0.25cm]
            \text{FINAL\_NORMALIZE}_i = \dfrac{\text{TP\_NORMALISE}_i+\text{TEST\_NORMALIZE}+\text{EMD}_1}{3}
        \end{cases}     
    \]
...
\begin{figure}[H] 
  \centering 
  \includegraphics[width=0.55\textwidth]{norm.png} 
\end{figure}

\newpage
    
    \item Final représente la \textbf{moyenne} par rapport aux notes de TP, Test et EMD.
    \item on met \(x\) final 1 et \(y\) final 2 et on ordone les valeurs : 
        \begin{enumerate}
            \item Moyenne :
            ...
            \end{figure}
                ...
                \begin{align*}
                    \overline{x} &= \dfrac{13+11.66+9.16+8.61+12.33+10+8.5+10.83+9.78+11.33}{10}\\[0.15cm]
                                 &= \dfrac{105.2}{10}\\[0.15cm]
                                 &= \boxed{10.52}\\[1cm]
                    \overline{y} &= \dfrac{14.5+12.66+12.74+11.66+13.08+14.16+11.41+11.91+11.08+14.24}{10}\\[0.15cm]
                                 &= \dfrac{127.44}{10}\\[0.15cm]
                                 &= \boxed{12.74}
                \end{align*}
            ...
            \item Mediane :
                ...
                \begin{align*}
                    \text{Med}(X) &= \dfrac{X\left[ \dfrac{N}{2}\right] + X\left[\dfrac{N}{2} + 1 \right]}{2}\\[0.15cm]
                                  &=\dfrac{X\left[ \dfrac{10}{2}\right] + X\left[\dfrac{10}{2} + 1 \right]}{2}\\[0.15cm]
                                  &=\dfrac{X\left[ 5 \right] + X\left[ 6 \right]}{2}\\[0.15cm]
                                  &=\dfrac{10+10.83}{2}\\[0.15cm]
                                  &= \boxed{10.415}\\[1cm]
                   \text{Med}(Y)  &= \dfrac{Y\left[ \dfrac{N}{2}\right] + Y\left[\dfrac{N}{2} + 1 \right]}{2}\\[0.15cm]
                                  &=\dfrac{Y\left[ \dfrac{10}{2}\right] + Y\left[\dfrac{10}{2} + 1 \right]}{2}\\[0.15cm]
                                  &=\dfrac{Y\left[ 5 \right] + Y\left[ 6 \right]}{2}\\[0.15cm]
                                  &=\dfrac{12.66+12.74}{2}\\[0.15cm]
                                  &= \boxed{12.7}
                \end{align*}

          \newpage
      \item Mode :
          \[\text{Mode}(X) = \boxed{13} \hspace{2cm} \text{Mode}(Y) = \boxed{14.5} \]
      ...
      \item \(Q_1\) et \(Q_3\) :
          ...
          \begin{align*}
              Q_1(X) &= X\left[ \dfrac {N}{4}\right]\\[0.15cm]
                     &= X\left [ \dfrac{10}{4}\right]\\[0.15cm]
                     &= X\left[ 2.5\right]\\
                     &= X\left[3\right]\\ 
                     &= \boxed{9.16}\\[0.45cm]
              Q_3(X) &= X\left[\dfrac{3\cdot N}{4}\right]\\[0.15cm]
                     &= X\left[\dfrac{3\cdot 10}{4}\right]\\[0.15cm]
                     &= X\left[7.5\right]\\
                     &= X\left[8\right]\\
                     &= \boxed{11.66}\\[1cm]
              Q_1(Y) &= Y\left[ \dfrac {N}{4}\right]\\[0.15cm]
                     &= Y\left[3\right]\\ 
                     &= \boxed{11.66}\\[0.45cm]
              Q_3(Y) &= Y\left[\dfrac{3\cdot N}{4}\right]\\[0.15cm]
                     &= Y\left[8\right]\\
                     &= \boxed{14.16}\\[1cm]
          \end{align*}

        \item Le résumé des cinq nombres :
            \[X \Rightarrow \text{min} = 8.5 \hspace{0.25cm} Q_1 = 9.16 \hspace{0.25cm} Q_2 = 10.415 \hspace{0.25cm} Q_3 = 11.66 \hspace{0.25cm} \text{max} = 13   \]
            \[Y \Rightarrow \text{min} = 11.08 \hspace{0.25cm} Q_1 = 11.66 \hspace{0.25cm} Q_2 = 12.7 \hspace{0.25cm} Q_3 = 14.16 \hspace{0.25cm} \text{max} = 14.5   \]
        \end{enumerate}
...
On calcule les limites :
\begin{align*}
    EIQ &= Q_3 - Q_1 = 11.66 - 9.16= \boxed{2.5}\\[0.1cm]
    \text{lim}_{inf} &= Q_1 - (1.5 \times EIQ) = 9.16 - (1.5 \times 2.5) = \boxed{5.41}\\[0.1cm]
    \text{lim}_{sup} &= Q_3 + (1.5 \times EIQ) = 11.66 + (1.5 \times 2.5) = \boxed{15.41}\\[0.1cm]
\end{align*}
...
\begin{prettyBox}{Limites}{red}
    \begin{itemize}
        \item On a \(\text{lim}_{inf} = 5.41\) , valeur normale et pas loin du min \(\Rightarrow\) on la prend comme limite.
        \item On a \(\text{lim}_{sup} = 15.41\) , valeur normale et pas loin du max \(\Rightarrow\) on la prend comme limite.
    \end{itemize}
\end{prettyBox}
...
On prend comme unité :\\[0.1cm]
8 carreaux \( \rightarrow \) 1

\vspace{0.25cm}

 \begin{figure}[H] 
  \centering 
  \includegraphics[width=0.95\textwidth]{boxfinal1.png} 
\end{figure}
...
On calcule les limites :
\begin{align*}
    EIQ &= Q_3 - Q_1 = 14.16 - 11.66= \boxed{2.5}\\[0.1cm]
    \text{lim}_{inf} &= Q_1 - (1.5 \times EIQ) = 11.66 - (1.5 \times 2.5) = \boxed{7.91}\\[0.1cm]
    \text{lim}_{sup} &= Q_3 + (1.5 \times EIQ) = 14.16 + (1.5 \times 2.5) = \boxed{17.91}\\[0.1cm]
\end{align*}
...
\begin{prettyBox}{Limites}{red}
    \begin{itemize}
        \item On a \(\text{lim}_{inf} = 7.91\) , valeur normale et pas loin du min \(\Rightarrow\) on la prend comme limite.
        \item On a \(\text{lim}_{sup} = 17.91\) , valeur normale et pas loin du max \(\Rightarrow\) on la prend comme limite.
    \end{itemize}
\end{prettyBox}
...
\vspace{0.25cm}
 ...
 \begin{figure}[H] 
  \centering 
  \includegraphics[width=0.95\textwidth]{boxfinal2.png} 
\end{figure}
...
\item QQ-Plot :
 ...
 \begin{figure}[H] 
  \centering 
  \includegraphics[width=0.95\textwidth]{scatter3.png} 
\end{figure}
...
\begin{prettyBox}{Conclusion}{myblue}
Toutes les moyennes de final 1 sont inférieures à celles de final 2.
\end{prettyBox}


\newpage
\item Coefficient Corrélation :
...
\begin{tabular}{ |c|c|c|c|c|c|c|c|c|c|c|} 
    \hline
    \(x_i\) & 8.5 & 8.61 & 9.16 & 9.78 & 10  & 10.83 & 11.33 & 11.66 & 12.33 & 13\\  
    \hline
    \((x_i - \overline{x})^2\) & 4.08 & 3.64 & 1.84 & 0.54 & 0.27 & 0.09 & 0.65 & 1.29 & 3.27 & 6.15  \\
    \hline
\end{tabular}
...
\begin{tabular}{ |c|c|c|c|c|c|c|c|c|c|c|} 
    \hline
    \(y_i\) & 11.08 & 11.41 & 11.66 & 11.91 & 12.66  & 12.74 & 13.08 & 14.16 & 14.24 & 14.5\\  
    \hline
    \((y_i - \overline{y})^2\) & 2.75 & 1.76 & 1.16 & 0.68 & 0.006 & 0 & 0.11 & 2.01 & 2.25 & 3.09  \\
    \hline
\end{tabular}
\end{center}
...
\begin{align*}
    \sigma_x & =\sqrt{\dfrac{\sum (x_i - \overline{x})^2}{N-1}}\\
             & =\sqrt{\dfrac{4.08 + 3.64 + 1.84 + 0.54 + 0.27 + 0.09 +0.65+ 1.29+ 3.27 +6.15}{10-1}}\\
             & =\sqrt{\dfrac{21.82}{9}}\\
             &= \sqrt{2.424}\\
             &=\boxed{1.556}\\[1cm]
    \sigma_y & =\sqrt{\dfrac{\sum (y_i - \overline{y})^2}{N-1}}\\
             & =\sqrt{\dfrac{2.75 + 1.76 + 1.16 + 0.68 + 0.006 + 0 +0.11+ 2.01+ 2.25 +3.09}{10-1}}\\
             & =\sqrt{\dfrac{13.81}{9}}\\
             &= \sqrt{1.535}\\
             &=\boxed{1.238}\\[0.5cm]
\end{align*}
...
\begin{align*}
    r  & =\dfrac{\sum (x_i - \overline{x}) \cdot (y_i - \overline{y})}{(N-1) \cdot (\sigma_x \cdot \sigma_y)} \\[0.25cm]
     & =\dfrac{\sum (x_i - \overline{x}) \cdot (y_i - \overline{y})}{(10-1) \cdot (1.556 \cdot 1.238)} \\[0.25cm]
                    &= \frac{
                        \substack {\sqrt{4.08} \cdot  \sqrt{2.75}  +
                              \sqrt{3.64} \cdot \sqrt{1.76} +
                             \sqrt{1.84} \cdot \sqrt{1.16} + 
                             \sqrt{0.54} \cdot \sqrt{0.68} +   
                            \sqrt{0.27} \cdot \sqrt{0.006}+
                            \sqrt{0.09} \cdot 0+
                            \sqrt{0.65} \cdot \sqrt{0.11} +
                            \sqrt{1.29} \cdot \sqrt{2.01}+
                            \sqrt{3.27} \cdot \sqrt{2.25} + 
                            \sqrt{6.15} \cdot \sqrt{3.09}
                        }
                    }{17.336}\\[0.25cm]
                    &= \frac{16.937}{17.336}\\[0.25cm]
                     &= \boxed { 0.977}
    \end{align*}
    ...
    \begin{prettyBox}{Conclusion}{myblue}
On a \( r = 0.977 > 0 \Rightarrow \) corrélation positive
    \end{prettyBox}
