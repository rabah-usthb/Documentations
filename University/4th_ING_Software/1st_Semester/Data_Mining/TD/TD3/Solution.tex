...
\begin{align*}
    &P(X_{\text{test}} = (\text{Ensoleillé , Non}) \hspace{0.1cm} | \hspace{0.1cm} Y = \text{Oui}) = P(x_1 = \text{Ensoleillé} \hspace{0.1cm} | \hspace{0.1cm} Y =\text{Oui}) \cdot P(x_2 = \text{Non} \hspace{0.1cm} | \hspace{0.1cm} Y =\text{Oui}) = \dfrac{1}{6} \cdot \dfrac{4}{6} = \dfrac{1}{9}\\[0.15cm] 
    &P(X_{\text{test}} = (\text{Ensoleillé , Non}) \hspace{0.1cm} | \hspace{0.1cm} Y = \text{Non}) = P(x_1 = \text{Ensoleillé} \hspace{0.1cm} | \hspace{0.1cm} Y =\text{Non}) \cdot P(x_2 = \text{Non} \hspace{0.1cm} | \hspace{0.1cm} Y =\text{Non}) = \dfrac{3}{4} \cdot \dfrac{1}{4} = \dfrac{3}{16} 
\end{align*}
...
\begin{align*}
    &\text{Numerateur(Oui)} = P ( X_{\text{test}} \hspace{0.1cm} | \hspace{0.1cm} Y = \text{Oui})\cdot P(\text{Oui}) = \dfrac{1}{9} \cdot \dfrac{6}{10} = 0.067\\[0.1cm]
    &\text{Numerateur(Non)} = P (X_{\text{test}} \hspace{0.1cm} | \hspace{0.1cm} Y = \text{Non})\cdot P(\text{Non}) = \dfrac{3}{16} \cdot \dfrac{4}{10} = 0.075
\end{align*}
