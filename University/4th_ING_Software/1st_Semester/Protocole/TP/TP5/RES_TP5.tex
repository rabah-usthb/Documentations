...
\begin{prettyBox}{Remarque}{red}
    On remarque que dans la table de routage des routeurs internes (pas les edge routers) qu'ils sont une route \verb|O*E| qui veut dire
    une route \textbf{OSPF} extenre a son systeme autonome c'est la route qui mene vers son edge router pour quitter le systeme autonome.
\end{prettyBox}
